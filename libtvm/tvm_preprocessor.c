...
static int
process_includes(char **src, int *src_len, struct tvm_htab_ctx *defines)
{
    ...
    char *begin = pp_directive_delimiter, *end = strchr(begin, '\n');
...
static int
process_defines(char **src, int *src_len, struct tvm_htab_ctx *defines)
{
...
static int
preprocess_pass(char **src, int *src_len, struct tvm_htab_ctx *defines)
{
    int ret = 0;
...
int
tvm_preprocess(char **src, int *src_len, struct tvm_htab_ctx *defines)
{
    int ret = 1;
